...
const pages = [
  ...
  },
  {
    ...
    content: `
      ...
      <p><strong>Role:</strong> Crypto Markets Reporter</p>
      ...
      <p><strong>Focus areas:</strong> Crypto markets, blockchain infrastructure, DeFi narratives, and retail-reader explainers.</p>
      <p><strong>Public profiles:</strong> <a href="https://about.me/rohancryptowrites" rel="nofollow noopener noreferrer" target="_blank">About.me</a> · <a href="https://x.com/revanmehta" rel="nofollow noopener noreferrer" target="_blank">X</a></p>
      <h2 id="jensen-ackles">Acklesverse</h2>
      <p><strong>Role:</strong> DeFi and Tokenomics Analyst</p>
      ...
      <p><strong>Focus areas:</strong> Token design, DAO governance, DeFi systems, and crypto market structure.</p>
      <p><strong>Public profiles:</strong> <a href="https://about.me/Acklesverse" rel="nofollow noopener noreferrer" target="_blank">About.me</a> · <a href="https://www.youtube.com/@Acklesverse" rel="nofollow noopener noreferrer" target="_blank">YouTube</a></p>
      <h2 id="yuki-matsuda">Yuki Matsuda</h2>
      <p><strong>Role:</strong> Altcoins and Web3 Gaming Reporter</p>
